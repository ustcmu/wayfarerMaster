...
public class LocationFetcherActivity extends Activity
{
    ...
    public void onConfirm(View view)
    {
        ...
        if(startAddr.equals("Current location")||startAddr.equals("current location")||
        		startAddr.equals("current")||startAddr.equals("Here")||startAddr.equals("here")){
        	startAddr = HERE;
        }

        String destAddr = destAddrAutoCompleteTextView.getText().toString();
        if(startAddr.equals("")||startAddr==null ||destAddr.equals("")||destAddr==null){
        	startAddr="";
        	destAddr="";
        }
